...
output_dir = f'/datasets/jianhaoy/Gen_Officehome/{algo}'

config = "Officehome/ResNet18_step"
...
# link_dict = '/homes/55/jianhaoy/projects/CIRL/officehome_link.json'
# link_dict = '/homes/55/jianhaoy/projects/CIRL/offichome_new_link.json'
