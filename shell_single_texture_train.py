...
source = ['original','in','random','edge','silo']
target = args.domain
...
# input_dir = '/datasets/jianhaoy/Texture/dataset/half_labels3'
input_dir = '/datasets/jianhaoy/Texture/dataset/reduced'
output_dir = f'/datasets/jianhaoy/Gen_Texture/{algo}'

config = "Texture/ResNet18_step"
